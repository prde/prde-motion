(ns ru.profitware.prde-motion.extended-protos
  (:require [ru.profitware.prde-motion.protocols :as l-protocols]
            [ru.profitware.prde-motion.frame :as l-frame]
            [ru.profitware.prde-motion.hand :as l-hand]
            [ru.profitware.prde-motion.finger :as l-finger]
            [ru.profitware.prde-motion.tool :as l-tool]
...
;; All ru.profitware.prde-motion/protocols are extended in this file.
